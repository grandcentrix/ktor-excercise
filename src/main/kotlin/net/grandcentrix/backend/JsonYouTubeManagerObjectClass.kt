...
class JsonYouTubeManagerObjectClass private constructor(
    ...
    companion object {
        val JsonYouTubeManagerObjectInstance: JsonYouTubeManagerObjectClass =
            JsonYouTubeManagerObjectClass(PlaylistManager())
    }
    ...
    override fun getYoutubeLinks(): List<VideoInfo> = youtubeLinks
    ...
    private fun validateVideoUrl(newVideoUrl: String?): Pair<HttpStatusCode, String>? {
